        ...
        this.setCaretCore = function (element, caretPosition) {
            ...
            element.childNodes.forEach(function (item, index) {
                ...
                if (item.nodeType === 3) {
                    ...
                    var charsInChild = _this.setCaretCore(item, caretPosition - charsInNode);
            ...
            ko.bindingHandlers.htmlLazy = {
                update: function (element, valueAccessor) {
                    ...
                    if (element.isContentEditable) {
                        ...
                        _this.setCaret(element, new Number(element.attributes.getNamedItem("data-carretPosition").value));
                    }
                }
            };
